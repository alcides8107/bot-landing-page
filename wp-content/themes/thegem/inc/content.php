...
function thegem_button($params = array(), $echo = false) {
	...
	if(isset($params['effects_enabled_delay']) && !empty($params['effects_enabled_delay'])) {
    ...
    if($params['effects_enabled']) {
        ...
        $output .= '<style type="text/css">.'.$unique.'.lazy-loading-before-start-animation .lazy-loading-item {opacity: 0;}</style>';
    }
