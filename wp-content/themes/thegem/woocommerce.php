 ...
 */
	...
	if(is_active_sidebar('shop-sidebar') && $thegem_item_data['sidebar_show'] && $thegem_sidebar_position) {
...
<?php
	if($thegem_item_data['title_style'] == 3 && $thegem_item_data['slideshow_type'] && !is_search()) {
