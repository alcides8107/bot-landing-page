				...
				<footer class="custom-footer<?php echo (function_exists('vc_is_page_editable') && vc_is_page_editable() ? ' frontent-edit-footer': ''); ?>">
						<?php if(function_exists('vc_is_page_editable') && vc_is_page_editable()) : ?>
							<div class="edit-template-overlay">
								<div class="buttons">
									<a href="<?php echo apply_filters( 'vc_get_inline_url', admin_url('post.php?vc_action=vc_inline&post_id='.$thegem_custom_footer->ID.'&post_type=thegem_footer')); ?>" target="_blank"><?php _e('Edit Custom Footer', 'thegem'); ?></a>
