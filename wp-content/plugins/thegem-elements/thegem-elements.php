...
function thegem_icon_packs_select_array() {
	$packs = array('elegant' => __('Elegant', 'thegem'), 'material' => __('Material Design', 'thegem'), 'fontawesome' => __('FontAwesome', 'thegem'), 'thegemdemo' => __('Additional', 'thegem'));
...
function thegem_elements_scripts() {
    ...
    wp_register_script('thegem-rellax', get_template_directory_uri() . '/js/rellax.min.js', array('jquery'), '', true);
	wp_register_script('thegem-interactions', get_template_directory_uri() . '/js/interactions.js', array('jquery', 'thegem-rellax'), null, true);
}
