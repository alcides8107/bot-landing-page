...
if(!function_exists('thegem_get_sanitize_qf_item_data')) {
    function thegem_get_sanitize_qf_item_data($post_id = 0, $item_data = array()) {
        ...
        $quickfinder_item_data['icon_pack'] = thegem_check_array_value(array('elegant', 'material', 'fontawesome', 'thegemdemo', 'userpack'), $quickfinder_item_data['icon_pack'], 'elegant');
