...
function thegem_counter_shortcode($atts) {
	...
	if(($icon_pack =='elegant' && $icon_elegant) || ($icon_pack =='material' && $icon_material) || ($icon_pack =='fontawesome' && $icon_fontawesome) || ($icon_pack =='thegemdemo' && $icon_thegemdemo) || ($icon_pack =='userpack' && $icon_userpack)) {
		...
		'gem_counter' => array(
			...
			'params' => array_merge(array(
				...
				array(
					...
					'heading' => __('Icon pack', 'thegem'),
					'param_name' => 'icon_pack',
					'value' => array_merge(array(__('Elegant', 'thegem') => 'elegant', __('Material Design', 'thegem') => 'material', __('FontAwesome', 'thegem') => 'fontawesome', __('Additional', 'thegem') => 'thegemdemo'), thegem_userpack_to_dropdown()),
